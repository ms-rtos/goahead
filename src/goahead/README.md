...
The purpose of this repository is for evaluating the GoAhead web server. This
GPL licensed version is an 
earlier verion of the GoAhead Enterprise Edition Web Server and does not have
all the features or fixes
